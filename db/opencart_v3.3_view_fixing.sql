...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Apr 2015 pada 06.36
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(4, 'Rupiah', 'IDR', 'Rp', '', '2', 1.00000000, 1, '2015-04-04 17:39:20');
...
(590, 1, 'html.44', 'column_right', 5),
(591, 1, 'testimoeditor.75', 'content_top', 10),
...
(589, 1, 'html.35', 'column_right', 2),
(470, 34, 'html.34', 'column_right', 0),
(588, 1, 'html.34', 'column_right', 1),
(498, 37, 'abouteditor.68', 'column_left', 0),
(497, 37, 'testimony.66', 'content_top', 0),
(587, 1, 'slideshow.27', 'content_top', 1),
(556, 35, 'comunity_layout.73', 'content_top', 0),
(586, 1, 'mostreviewed.46', 'content_top', 2),
(585, 1, 'gallery_event_simple.72', 'column_right', 4),
(584, 1, 'toprated.47', 'content_top', 3),
(583, 1, 'tweetbook', 'content_top', 5),
(582, 1, 'latest.48', 'content_top', 4);
...
(126, 10, 6, 'book', '', '', '', '', '', '', '', 999, 6, 'cover/100405150401_tata_kecantikan kulit.jpg', '', 0, 1, '25.0000', 0, 0, '0000-00-00', '0.25000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, 1, 1, 1, 0, 4, '2015-04-01 22:20:10', '2015-04-01 22:30:38'),
...
--
ALTER TABLE `oc_extension`
MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=474;
--
...
--
ALTER TABLE `oc_layout_route`
MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=192;
--
