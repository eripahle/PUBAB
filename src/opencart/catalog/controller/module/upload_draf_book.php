...
class ControllerModuleUploadDrafBook extends Controller {	
	...
	public function index() {
		...
		$this->load->model('catalog/upload_draf_book');		
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_upload_draf_book->addProduct($this->request->post);
	...
	protected function getForm() {
		...
		$data['content_top'] = $this->load->controller('module/produk_form');		
		$data['footer'] = $this->load->controller('common/footer');
		$data['header'] = $this->load->controller('common/header');
                
		$this->response->setOutput($this->load->view('default/template/module/uploaddrafbook.tpl', $data));
	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'module/upload_draf_book')) {
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
			$this->load->model('module/upload_draf_book');
			$this->load->model('module/option');
