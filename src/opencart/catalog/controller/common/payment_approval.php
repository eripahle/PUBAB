...
class ControllerCommonPaymentApproval extends Controller {
    ...
    protected function getList() {
		...
		$data['copy'] = $this->url->link('catalog/payment_approval/copy', ' ', 'SSL');
		$data['delete'] = $this->url->link('catalog/payment_approval/delete', ' ', 'SSL');
...
//			$product_info = $this->model_catalog_product->getProductForEdit($this->request->get['payment_id']);
//		}
