<html>
    <head>	
        ...
        <script type="text/javascript" src="catalog/view/javascript/fancybox/jquery-1.10.1.min.js"></script>
        ...
        <link rel="stylesheet" type="text/css" href="catalog/view/javascript/fancybox/jquery.fancybox-buttons.css?v=1.0.5" />
        <script type="text/javascript" src="catalog/view/javascript/fancybox/jquery.fancybox-buttons.js?v=1.0.5"></script>

        <!-- Add Thumbnail helper (this is optional) -->
        <link rel="stylesheet" type="text/css" href="catalog/view/javascript/fancybox/jquery.fancybox-thumbs.css?v=1.0.7" />
        <script type="text/javascript" src="catalog/view/javascript/fancybox/jquery.fancybox-thumbs.js?v=1.0.7"></script>

        <!-- Add Media helper (this is optional) -->
        <script type="text/javascript" src="catalog/view/javascript/fancybox/jquery.fancybox-media.js?v=1.0.6"></script>
                ...
                <div id="container">	
                    ...
                    <li>
                        <a class="fancybox-effects-b" href="<?php echo $gallerysingle['image'];?>"
                           title="<?php echo $gallerysingle['title'];?> - <?php echo $gallerysingle['description'];?>"><img src="<?php echo $gallerysingle['image'];?>" width="100" /></a>                
                    </li>
                </div>        
                <?php } ?>                   
            </ul>
