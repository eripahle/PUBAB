...
class ModelModuleUploadDraf extends Model {
    ...
    public function addProduct($data, $file, $stat) {
        print_r($file);
        if ($stat) {
            //pre conditions
            $dot = '.';
            ...
            $sql = "INSERT INTO oc_product_image VALUES(NULL, $product_id,'$lokasi_caver',0)";
            $this->db->query($sql);
            ...
            $sql = "INSERT INTO oc_draf VALUES(NULL, $product_id,'$lokasi_buku','$tgl_buku', '$nama_buku', '$file_ext_buku', '$file_size_buku')";
            $this->db->query($sql);
