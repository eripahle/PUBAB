<?php
class ModelPaymentPaymentApproval extends Model {
	...
	public function getTotalPayment($data = array()) {
		//$sql = "SELECT COUNT(DISTINCT p.product_id) AS total";
                $sql = "SELECT COUNT(*) AS total FROM ".DB_PREFIX."payment";
...
//		}
	...
	public function addPayment($data,$customer_id,$data2 = array ()) {
