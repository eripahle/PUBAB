      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-jne-reguler" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <select name="jne_oke_tax_class_id">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="jne_oke_sort_order" value="<?php echo $jne_oke_sort_order; ?>" size="1" />
            </div>
          </div>
            ...
            <?php foreach ($geo_zones as $geo_zone) { ?>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <textarea name="jne_oke_<?php echo $geo_zone['geo_zone_id']; ?>_rate" cols="100" rows="15"><?php echo ${'jne_oke_' . $geo_zone['geo_zone_id'] . '_rate'}; ?>
                  </textarea>
                </div>
              </div>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <select name="jne_oke_<?php echo $geo_zone['geo_zone_id']; ?>_status">
