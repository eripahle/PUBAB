<ul id="menu">
    ...
    <li id="managment"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_managment; ?></span></a>
        <ul>            
            ...
            <li><a href="<?php echo $payment_approvement_admin; ?>"><?php echo $text_payment_approvement; ?></a></li>            
            <li><a href="<?php echo $editor_managment_admin;?>"><?php echo $text_editor; ?></a></li>            
        </ul>
    </li>
